    ...
    void propIsLeft() {
        do {
            switch (step) {
                ...
                case 60:
                    driveMoveCompleted = strafeRight(33);
    ...
    void propIsCenter() {
        do {
            switch (step) {
                ...
                case 5510:
                    driveMoveCompleted = strafeRight(5);
    ...
    void propIsRight() {
        do {
            switch (step) {
                ...
                case 35:
                    //make sure wrist is out, then drops on right Spike Mark
                    setWristOut();
                    sleep(250);
                    rightClaw.setPosition(CLAW_OPEN);
                    sleep(750);
